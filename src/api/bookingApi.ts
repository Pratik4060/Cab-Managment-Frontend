...
export function normalizeBooking(booking: any) {
  ...
  return {
    ...
    emailScreenshot: booking.emailScreenshot || booking.email_screenshot || booking.email_screenshot_url || "",
    email_screenshot: booking.email_screenshot || booking.emailScreenshot || booking.email_screenshot_url || null,
    email_screenshot_url: booking.email_screenshot_url || booking.email_screenshot || booking.emailScreenshot || null,
