...
export function StatCard({ icon: Icon, label, value, tone = "brand" }: StatCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`panel group relative overflow-hidden rounded-xl border border-l-[4px] border-brand-100/80 p-4 shadow-xl ${styles.border} ${styles.glow} transition hover:-translate-y-0.5 hover:shadow-2xl dark:border-red-950/35 dark:bg-gradient-to-br dark:from-[#181113] dark:to-[#0e0e10]`}
    >
